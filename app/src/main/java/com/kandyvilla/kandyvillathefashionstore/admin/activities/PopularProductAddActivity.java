...
public class PopularProductAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_product_add);
    ...
    private void productinsert() {
        ...
        DocumentReference pop_product = firestore.collection("PopularProducts").document();
        ...
        pop_product
                .set(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        new SweetAlertDialog(PopularProductAddActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                                .setTitleText("Product Added Succesfully")
                                .show();
                    }
                });
        ...
        if (data.getData() != null) {
            ...
            storageReference.putFile(productUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(PopularProductAddActivity.this, "Image uploaded !", Toast.LENGTH_SHORT).show();
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override
                        public void onSuccess(Uri uri) {
                            url = uri.toString();
                            Toast.makeText(PopularProductAddActivity.this, "Product Image Uploaded Successfully !", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
